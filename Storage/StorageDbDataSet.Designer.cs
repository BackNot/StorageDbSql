...
namespace Storage {
    ...
    public partial class StorageDbDataSet : global::System.Data.DataSet {
        ...
        public partial class ItemsDataTable : global::System.Data.TypedTableBase<ItemsRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public ItemsRow AddItemsRow(int ItemQuantity, decimal ItemPrice, string ItemName, string ItemDescription, int Purchase_PurchaseId) {
        ...
        public partial class ItemsRow : global::System.Data.DataRow {
            ...
            public int Purchase_PurchaseId {
                get {
                    try {
                        return ((int)(this[this.tableItems.Purchase_PurchaseIdColumn]));
                    }
                    catch (global::System.InvalidCastException e) {
                        throw new global::System.Data.StrongTypingException("The value for column \'Purchase_PurchaseId\' in table \'Items\' is DBNull.", e);
                    }
                }
                set {
                    this[this.tableItems.Purchase_PurchaseIdColumn] = value;
                }
            }
            ...
            public bool IsPurchase_PurchaseIdNull() {
                return this.IsNull(this.tableItems.Purchase_PurchaseIdColumn);
            }
            
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public void SetPurchase_PurchaseIdNull() {
                this[this.tableItems.Purchase_PurchaseIdColumn] = global::System.Convert.DBNull;
            }
        }
...
namespace Storage.StorageDbDataSetTableAdapters {
    ...
    public partial class ItemsTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[Items] WHERE (([ItemId] = @Original_ItemId) AND ([ItemQuantity] = @Original_ItemQuantity) AND ([ItemPrice] = @Original_ItemPrice) AND ((@IsNull_Purchase_PurchaseId = 1 AND [Purchase_PurchaseId] IS NULL) OR ([Purchase_PurchaseId] = @Original_Purchase_PurchaseId)))";
            ...
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [dbo].[Items] ([ItemQuantity], [ItemPrice], [ItemName], [ItemDescription], [Purchase_PurchaseId]) VALUES (@ItemQuantity, @ItemPrice, @ItemName, @ItemDescription, @Purchase_PurchaseId);
SELECT ItemId, ItemQuantity, ItemPrice, ItemName, ItemDescription, Purchase_PurchaseId FROM Items WHERE (ItemId = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Items] SET [ItemQuantity] = @ItemQuantity, [ItemPrice] = @ItemPrice, [ItemName] = @ItemName, [ItemDescription] = @ItemDescription, [Purchase_PurchaseId] = @Purchase_PurchaseId WHERE (([ItemId] = @Original_ItemId) AND ([ItemQuantity] = @Original_ItemQuantity) AND ([ItemPrice] = @Original_ItemPrice) AND ((@IsNull_Purchase_PurchaseId = 1 AND [Purchase_PurchaseId] IS NULL) OR ([Purchase_PurchaseId] = @Original_Purchase_PurchaseId)));
SELECT ItemId, ItemQuantity, ItemPrice, ItemName, ItemDescription, Purchase_PurchaseId FROM Items WHERE (ItemId = @ItemId)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT ItemId, ItemQuantity, ItemPrice, ItemName, ItemDescription, Purchase_Purch" +
                "aseId FROM dbo.Items";
        ...
        public virtual int Fill(StorageDbDataSet.ItemsDataTable dataTable) {
        ...
        public virtual StorageDbDataSet.ItemsDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            StorageDbDataSet.ItemsDataTable dataTable = new StorageDbDataSet.ItemsDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(StorageDbDataSet.ItemsDataTable dataTable) {
        ...
        public virtual int Delete(int Original_ItemId, int Original_ItemQuantity, decimal Original_ItemPrice, global::System.Nullable<int> Original_Purchase_PurchaseId) {
            this.Adapter.DeleteCommand.Parameters[0].Value = ((int)(Original_ItemId));
            this.Adapter.DeleteCommand.Parameters[1].Value = ((int)(Original_ItemQuantity));
            ...
            if ((Original_Purchase_PurchaseId.HasValue == true)) {
                ...
                this.Adapter.DeleteCommand.Parameters[4].Value = ((int)(Original_Purchase_PurchaseId.Value));
            }
            else {
        ...
        public virtual int Insert(int ItemQuantity, decimal ItemPrice, string ItemName, string ItemDescription, global::System.Nullable<int> Purchase_PurchaseId) {
            this.Adapter.InsertCommand.Parameters[0].Value = ((int)(ItemQuantity));
            ...
            if ((Purchase_PurchaseId.HasValue == true)) {
                this.Adapter.InsertCommand.Parameters[4].Value = ((int)(Purchase_PurchaseId.Value));
            }
            else {
        ...
        public virtual int Update(int ItemQuantity, decimal ItemPrice, string ItemName, string ItemDescription, global::System.Nullable<int> Purchase_PurchaseId, int Original_ItemId, int Original_ItemQuantity, decimal Original_ItemPrice, global::System.Nullable<int> Original_Purchase_PurchaseId, int ItemId) {
            this.Adapter.UpdateCommand.Parameters[0].Value = ((int)(ItemQuantity));
            ...
            if ((Purchase_PurchaseId.HasValue == true)) {
                this.Adapter.UpdateCommand.Parameters[4].Value = ((int)(Purchase_PurchaseId.Value));
            }
            else {
                this.Adapter.UpdateCommand.Parameters[4].Value = global::System.DBNull.Value;
            }
            this.Adapter.UpdateCommand.Parameters[5].Value = ((int)(Original_ItemId));
            this.Adapter.UpdateCommand.Parameters[6].Value = ((int)(Original_ItemQuantity));
            this.Adapter.UpdateCommand.Parameters[7].Value = ((decimal)(Original_ItemPrice));
            if ((Original_Purchase_PurchaseId.HasValue == true)) {
                this.Adapter.UpdateCommand.Parameters[8].Value = ((object)(0));
                this.Adapter.UpdateCommand.Parameters[9].Value = ((int)(Original_Purchase_PurchaseId.Value));
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(int ItemQuantity, decimal ItemPrice, string ItemName, string ItemDescription, global::System.Nullable<int> Purchase_PurchaseId, int Original_ItemId, int Original_ItemQuantity, decimal Original_ItemPrice, global::System.Nullable<int> Original_Purchase_PurchaseId) {
            return this.Update(ItemQuantity, ItemPrice, ItemName, ItemDescription, Purchase_PurchaseId, Original_ItemId, Original_ItemQuantity, Original_ItemPrice, Original_Purchase_PurchaseId, Original_ItemId);
        }
    }
